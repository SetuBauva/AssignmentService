...
@SpringBootTest
@ActiveProfiles("test")
@ContextConfiguration(classes = {SpringSecurityConfig.class,AssignmentService.class})
...
public class CustomerSecurityTest {
	...
	@Test
	public void updateCustomerStatusSuccess() throws Exception {

		when(customerRepository.updateStatus("Active", 1, 111111111)).thenReturn(1);

		mockMvc.perform(patch("/customerStatus"))
